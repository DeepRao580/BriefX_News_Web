...
function Navbar() {
  ...
  return (
    <div className="bg-white">
      <div className="navbar bg-white shadow-sm px-8 py-4">
        ...
        <div className="dropdown dropdown-end">
          <div tabIndex={0} role="button" className="btn btn-ghost btn-circle">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="inline-block h-5 w-5 stroke-black">
      ...
      <div style={{ padding: 10 }}>
        <ul className="flex items-center justify-center gap-8 font-medium text-black text-[18px]">
          <Link to="/searchnews" className="flex items-center gap-2 hover:text-gray-600 transition-all duration-300 relative after:absolute after:left-0 after:-bottom-1 after:h-0.5 after:w-0 after:bg-black after:transition-all after:duration-300 hover:after:w-full">
      ...
      <button onClick={toggleLang} className="fixed bottom-22 right-6 z-50 rounded-full bg-blue-500 px-6 py-3 text-lg font-semibold text-white shadow-2xl transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:bg-blue-700 active:scale-95">{lang === "en" ? "हिंदी" : "English"}</button>
