  ...
  useEffect(() => {
    const fetchRecentNews = async () => {
      try {
        ...
        "https://api.currentsapi.services/v1/search?keywords=AI OR technology OR startups OR cybersecurity OR cloud computing&language=en&country=IN&page_size=20",
          {
            headers: {
              Authorization:
